...
<body>
	...
	<header id="header">
		<div class="container main-menu">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.php"><img src="img/Logo.png" height="100" width="100" alt="" title="" /></a>
				</div>
			...
			<div class="row d-flex justify-content-center">
				<div class="col-lg-6">
					<div class="section-title text-center">
						...
						<p>Iwansell is not just about profit... iwansell is about people, its about creating opportunities, its about playing our own part in making the world a better place.
						</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="single-feature">
						<a href="#" class="title">
							<span><img src="img/eshop.png" height="100" width="100" alt="" title="" /></span>
							<h3>eShops</h3>
						</a>
						<p>
							The online shop to boost your radar so your business can reach tens of thousands to millions of people, near you.
						</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="single-feature">
						<a href="#" class="title">
							<span><img src="img/analytics.png" height="100" width="100" alt="" title="" /></span>
							<h3>Business Mode</h3>
						</a>
						<p>
							A Business Information System to grant you access to data on activities in a particular campus marketplace.
						</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="single-feature">
						<a href="#" class="title">
							<span><img src="img/padlock.png" height="100" width="100" alt="" title="" /></span>
							<h3>Security</h3>
						</a>
						<p>
							To keep our users safe, we provide a platform to generate reciepts for each complete transaction.
						</p>
					</div>
				</div>
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="offset-lg-1 col-lg-5 home-about-right">
					...
					<p>
						 It would be faster and cheaper to complete transaction with someone in your town, than with someone in another town or
						 state. Iwansell can do it faster by connecting you with someone or a 
						 virtual shop and you can complete a transaction in at fast as an hour or a day, and cutting all extra transaction cost of transportation and delivery.
	...
	Copyright &copy;<script>document.write(new Date().getFullYear());</script> iwansell LLC.</p>
